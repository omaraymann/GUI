 ...
 * @author 20127
 */
public class EmployeeLoginWindow extends javax.swing.JFrame implements Node{

    private Node parent;
    private EmployeeRoleWindow employee;
    /**
     * Creates new form EmployeeLoginWindow
     */
    ...
    private void login_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_login_btnActionPerformed
        ...
        }else if(!Username.getText().equals(LoginCredentials.EMPLOYEE_USERNAME) || !password.getText().equals(LoginCredentials.EMPLOYEE_PASSWORD))
        {
            JOptionPane.showMessageDialog(null,"Wrong username or password!");
        }else
        {
            if(employee == null)
                employee = new EmployeeRoleWindow();
